...
namespace silt
{
    ...
    TEST_F(Silt_Combi_Test, TestSimpleInsertRetrieve1) {
    ...
    TEST_F(Silt_Combi_Test, TestSimpleInsertRetrieve2) {
    ...
    TEST_F(Silt_Combi_Test, TestSimpleInsertRetrieve4) {
    ...
    TEST_F(Silt_Combi_Test, TestSimpleSortedInsertRetrieveSome) {
    ...
    TEST_F(Silt_Combi_Test, TestSimpleSortedInsertRetrieveSomeSome) {
		generate_random_kv(arr_, key_len_, data_len_, 100);
    ...
    TEST_F(Silt_Combi_Test, TestSimpleSortedInsertRetrieveMany) {
    ...
    TEST_F(Silt_Combi_Test, TestSimpleSortedInsertRetrieveManyMany) {
		generate_random_kv(arr_, key_len_, data_len_, size_);
    ...
    TEST_F(Silt_Combi_Test, DISABLED_TestSimpleSortedInsertRetrieveManyOnTheFly) {
		int64_t operations_per_sec = 100000L;
		RateLimiter rate_limiter(0, operations_per_sec, operations_per_sec / 1000L, 1000000000L / 1000L);
        ...
        for (size_t i = 0; i < 10000000; i++) {
            ...
            EXPECT_EQ(OK, silt_->Put(RefValue(key, key_len_), RefValue(key + key_len_, data_len_)));
		}
    ...
    TEST_F(Silt_Combi_Test, TestFlush) {
        EXPECT_EQ(OK, silt_->Flush());
        EXPECT_EQ(OK, silt_->Flush());
    }
